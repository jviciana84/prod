...
interface CarSilhouetteRightProps {
  onPartClick: (part: string) => void
  damages: VehicleDamage[]
  getDamageColor: (damageType: DamageType) => string
}

export default function CarSilhouetteRight({ onPartClick, damages, getDamageColor }: CarSilhouetteRightProps) {
  ...
  return (
    <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-6">
      <h3 className="text-lg font-bold text-gray-800 mb-4 text-center">Vista Lateral Derecha</h3>
      ...
      <div className="relative max-w-lg mx-auto mb-6">
        <div className="bg-white rounded-xl p-4 border-2 border-gray-300 shadow-lg">
          ...
          >
            <img 
              src="/svg/lateral.svg" 
              alt="Coche lateral derecho - Haz clic para marcar daños"
              className="w-full h-auto max-h-80 object-contain scale-x-[-1]"
