  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="text-center">
        <h1 className="text-3xl font-bold mb-2">Debug Subscriptions</h1>
        <p className="text-gray-600">Página de debug para notificaciones</p>
      </div>
