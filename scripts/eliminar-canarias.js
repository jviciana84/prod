...
console.log('🔍 Usando mapa sin Islas Canarias...');
...
// Generar el código del componente sin las Canarias
...
${pathsCode}
            ...
            {provincias.map((provincia, index) => {
              // Coordenadas aproximadas para provincias principales (solo península)
...
console.log('\n🎯 Mapa limpio con:');
console.log(`- ${pathMatches.length} provincias peninsulares del SVG sin Canarias`);
console.log('- Sin Islas Canarias (eliminadas completamente)');
console.log('- Solo península ibérica');
...
console.log('- Coordenadas optimizadas para provincias peninsulares');
