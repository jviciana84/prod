...
-- 2. Crear/actualizar mapeos de columnas básicos
INSERT INTO column_mappings (
    ...
    ('Fecha compra DMS', 'Fecha compra DMS', 'purchase_date_duc', true)
ON CONFLICT (name) DO UPDATE SET
    is_active = EXCLUDED.is_active,
    updated_at = NOW();
