-- =====================================================
-- PERMITIR NULL EN PURCHASE_DATE
-- =====================================================

-- 1. Modificar la columna purchase_date para permitir NULL
SELECT '=== MODIFICANDO COLUMNA PURCHASE_DATE PARA PERMITIR NULL ===' as info;
ALTER TABLE nuevas_entradas 
ALTER COLUMN purchase_date DROP NOT NULL;

-- 2. Verificar que se modificó correctamente
SELECT '=== VERIFICAR QUE SE MODIFICÓ CORRECTAMENTE ===' as info;
SELECT 
    column_name,
    data_type,
    is_nullable,
...
-- 3. Insertar los 23 vehículos faltantes con NULL en fecha cuando no hay fecha válida
SELECT '=== INSERTAR VEHÍCULOS FALTANTES CON NULL EN FECHA ===' as info;
...
SELECT 
    ...
    CASE 
        ...
        ELSE NULL  -- NULL cuando no hay fecha válida
    END,
    false,
    CASE 
...
-- 6. Actualizar la función principal para usar NULL en fecha
    ...
    LOOP
        ...
        LOOP
            ...
            IF NOT EXISTS (
                ...
                -- Convertir fecha (NULL cuando no es válida)
                BEGIN
                    ...
                    ELSE
                        converted_date := NULL;  -- NULL cuando no hay fecha válida
                    END IF;
                EXCEPTION WHEN OTHERS THEN
                    converted_date := NULL;  -- NULL cuando hay error
                END;
                ...
                BEGIN
                    ...
                    RAISE NOTICE 'Vehículo añadido: % - % (%s) - Fecha: %', 
