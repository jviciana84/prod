-- =====================================================
-- ARREGLAR CONVERSIÓN DE FECHA
-- =====================================================

-- 1. Crear función con conversión de fecha corregida
        ...
        LOOP
            ...
            IF NOT EXISTS (
                ...
                EXCEPTION WHEN OTHERS THEN
                    RAISE NOTICE 'Error convirtiendo fecha "%" para matrícula %: %', 
...
SELECT '=== PROBANDO FUNCIÓN CON FECHA CORREGIDA ===' as info;
