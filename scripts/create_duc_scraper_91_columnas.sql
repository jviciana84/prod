-- =====================================================
-- CREAR TABLA DUC_SCRAPER - 91 COLUMNAS + 5 METADATOS
-- =====================================================
-- Fecha: $(Get-Date -Format "yyyy-MM-dd HH:mm:ss")
-- Descripción: Crear tabla duc_scraper con las 91 columnas exactas del CSV de BMW
-- =====================================================

-- Crear tabla duc_scraper con las 91 columnas exactas del CSV
CREATE TABLE IF NOT EXISTS public.duc_scraper (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    
    -- 91 COLUMNAS EXACTAS DEL CSV
    "ID Anuncio" TEXT,
    "Anuncio" TEXT,
    "BPS / NEXT" TEXT,
    "Cambio" TEXT,
...
COMMENT ON TABLE public.duc_scraper IS 'Tabla madre para almacenar datos extraídos directamente del CSV de BMW';
...
BEGIN
    RAISE NOTICE '=====================================================';
    RAISE NOTICE 'TABLA MADRE DUC_SCRAPER CREADA EXITOSAMENTE';
    RAISE NOTICE '=====================================================';
    RAISE NOTICE 'Columnas creadas: 91 columnas del CSV + 5 metadatos = 96 total';
