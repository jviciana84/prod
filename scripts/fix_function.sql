-- =====================================================
-- ARREGLAR FUNCIÓN DE PROCESAMIENTO
-- =====================================================

-- 1. Crear función corregida
...
BEGIN
    ...
    LOOP
        ...
        -- Procesar vehículos que cumplan los filtros básicos
        FOR vehicle_record IN 
            SELECT * FROM duc_scraper 
            WHERE 
                "Marca" = 'BMW'  -- Solo BMW
                AND "Disponibilidad" = 'Disponible'  -- Solo disponibles
                AND "Matrícula" IS NOT NULL  -- Con matrícula
...
SELECT '=== PROBANDO FUNCIÓN CORREGIDA ===' as info;
