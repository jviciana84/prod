...
const normalizarProvincia = (provincia: string): string => {
  ...
  const casosEspeciales: Record<string, string> = {
    ...
    'elche': 'Elche',
    'mostoles': 'M├│stoles',
    'alcala de henares': 'Alcal├í de Henares',
    ...
    'san sebastian de los reyes': 'San Sebasti├ín de los Reyes',
  ...
  // Si no est├í en casos especiales, aplicar capitalizaci├│n general
...
export function InformeVentasMensual() {
  ...
  const fetchVentasMensual = async (mesString: string) => {
    try {
      ...
      console.log("­ƒöì Obteniendo ventas del mes:", mesString)
      console.log("­ƒôà Desde:", fechaInicio.toISOString())
      console.log("­ƒôà Hasta:", fechaFin.toISOString())
      ...
      console.log(`­ƒôè Ventas encontradas: ${ventasData?.length || 0}`)
  ...
  const fetchVentasSemanal = async (inicio: Date, fin: Date) => {
    try {
      ...
      console.log("­ƒöì Obteniendo ventas de la semana")
      console.log("­ƒôà Desde:", inicio.toISOString())
      console.log("­ƒôà Hasta:", fin.toISOString())
  ...
  const calcularEstadisticas = useCallback((ventasData: VentaMensual[]) => {
    ...
    // Datos geogr├íficos para el mapa
    ...
    const rangosPrecio = [
      { min: 0, max: 10000, label: "0-10k Ôé¼" },
      { min: 10000, max: 20000, label: "10k-20k Ôé¼" },
      { min: 20000, max: 30000, label: "20k-30k Ôé¼" },
      { min: 30000, max: 50000, label: "30k-50k Ôé¼" },
      { min: 50000, max: Infinity, label: "50k+ Ôé¼" }
    ]
        ...
        <div className="flex items-center gap-4">
          ...
          <Select value={tipoGrafico} onValueChange={(value: any) => setTipoGrafico(value)}>
            ...
            <SelectContent>
              ...
              <SelectItem value="area">├ürea</SelectItem>
            </SelectContent>
          </Select>
        </div>
          ...
          <div className="grid gap-6 grid-cols-1 lg:grid-cols-3">
            ...
            <Card className="flex flex-col h-[720px] lg:col-span-2">
              <CardHeader className="flex-shrink-0">
                <div>
                  <CardTitle>Distribuci├│n Geogr├ífica de Ventas</CardTitle>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Tipos de descuentos m├ís comunes</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>An├ílisis de financiaci├│n vs contado</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-6">
